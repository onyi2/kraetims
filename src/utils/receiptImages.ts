...
export const generateMpesaSvg = (amount: number, refNo: string, studentName: string, dateStr: string): string => {
  ...
  const svg = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 500" width="100%" height="100%">
    ...
    <text x="200" y="152" fill="#558B2F" font-family="-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, sans-serif" font-weight="700" font-size="11" text-anchor="middle" letter-spacing="1">PAID TO SHOP OWNER</text>
    ...
    <text x="200" y="452" fill="#999" font-family="monospace" font-size="8" text-anchor="middle">RECONCILED BY SHOP OWNER ADMIN</text>
  </svg>`;
...
export const generateChequeSlipSvg = (amount: number, refNo: string, studentName: string, dateStr: string): string => {
  ...
  const svg = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 250" width="100%" height="100%">
    ...
    <text x="70" y="85" fill="#1A237E" font-family="sans-serif" font-weight="800" font-size="13">SHOP OWNER</text>
...
/**
 * Generates an SVG representation of an official Shop Owner uniform/item fee schedule slip,
...
export const generateUniformPriceListSlipSvg = (): string => {
  const svg = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 540 370" width="100%" height="100%">
    ...
    <!-- Header Text -->
    <text x="290" y="32" font-family="-apple-system, sans-serif" font-weight="900" font-size="16" fill="#1E3A8A" text-anchor="middle" letter-spacing="1">SHOP OWNER</text>
    ...
    <g transform="translate(320, 155) scale(0.52)" filter="url(#inkBleed)">
      ...
      <g font-family="-apple-system, sans-serif" text-anchor="middle" fill="#2563EB">
        <text x="210" y="44" font-size="12" font-weight="900" letter-spacing="0.5">SHOP OWNER</text>
      ...
      <g font-family="-apple-system, sans-serif" text-anchor="middle" fill="#2563EB">
        ...
        <text x="190" y="167" font-size="9" font-weight="bold">info@shopowner.co.ke</text>
      </g>
