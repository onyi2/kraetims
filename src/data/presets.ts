...
// Shop Owner default configuration
export const defaultSchoolConfig: SchoolConfig = {
  ...
  website: "www.shopowner.co.ke",
  kraPin: "P051238491A",
  etimsRegNo: "ETIMS-109485721",
  schoolRegNo: "REG-0984/2018"
};

// Complete product and fees catalogs loaded from Shop Owner specs
export const productPresets: ProductPreset[] = [
  ...
  { id: 'g2u-bag', description: 'Premium Branded Bag', category: 'Uniforms', unitPrice: 2500, grade: 'Grade 2' },
  ...
  { id: 'g5u-bag', description: 'Premium Branded Bag L', category: 'Uniforms', unitPrice: 2500, grade: 'Grade 5' },
